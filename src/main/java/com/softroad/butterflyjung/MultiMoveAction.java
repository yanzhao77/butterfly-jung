...
public final class MultiMoveAction extends WidgetAction.LockedAdapter {
    ...
    static final class MoveData implements Iterable<MoveData> {
        ...
        public MoveData(Widget widget, WidgetMouseEvent event, MoveProvider provider) {
            movingWidget = widget;
        ...
        public MoveData add(Widget widget, WidgetMouseEvent event, MoveProvider provider) {
    ...
    public State mouseDragged(Widget widget, WidgetMouseEvent event) {
        ...
        return moved ? State.createLocked(widget, this) : State.REJECTED;
    }
